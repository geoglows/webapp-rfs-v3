/**
 * The basemaps, and the mechanism the picker switches them with. Every raster set is declared in
...
/** Every basemap on offer, in the order the picker lists them. */
const BASEMAPS = [
...
async function addEnvironment(map, conf) {
  ...
  // Global map state, which is why this whole function runs at most once.
