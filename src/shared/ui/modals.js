/**
 * Opening and closing the dialogs on both pages: every modal is a `.backdrop` holding one
 * `.card.modal`, hidden by a class, so there is one way in and three ways out.
 *
